...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors && $postModel->update($id, $title, $content, $imageName)) {
...
<head>
    ...
    <title>Edit Post - Mini CMS</title>
                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" id="postForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" required value="<?= h($_POST['title'] ?? $post['title']) ?>">
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="content" class="form-control" rows="8" required><?= h($_POST['content'] ?? $post['content']) ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if (!empty($post['image'])): ?>
                                ...
                                ?>
                                    <img src="/uploads/<?= h($post['image']); ?>" alt="<?= h($post['title']); ?>" class="img-thumbnail mb-2" style="max-width: 150px;" onerror="this.style.display='none';">
                                <?php else: ?>
                                    <span class="text-muted">Image file not found</span>
                                <?php endif; ?>
                            <?php else: ?>
